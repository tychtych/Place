...
class CardList {
    ...
    /*REVIEW. Надо лучше. Лучше, чтобы класс CardList не знал, что у класса Card есть метод create, это бы сделало эти классы более
    независимыми друг от друга, то есть целесообразно подумать о передаче в методы CardList не самого экземпляра Card для каждой карточки,
